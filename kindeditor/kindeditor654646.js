...
(function(window, undefined) {
    ...
    K.options = {
        ...
        htmlTags: {
            video: ['src', 'width', 'height', 'loop', 'autoplay'],
    ...
    function _mediaType(src) {
        ...
        if (/\.(avi|wmv|mpeg|mp4|mov|mkv|flv|f4v|m4v|rmvb|rm|3gp|dat|ts|mts|vob)(\?|$)/i.test(src)) {
            return "htmlfvideo";
        }
    ...
    function _htmlfvideo(attrs) {
        ...
        html += ' controls="controls" autoplay="false"></video>';
        return html;
    }
    ...
    function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
        var arr = [
            ...
            '	height:100px;',
            '}',
            'img.ke-htmlfvideo,img.ke-media {',
            '	border:1px solid #AAA;',
            '	background-image:url(' + themesPath + 'common/media.gif);',
            '	background-position:center center;',
            '	background-repeat:no-repeat;',
    ...
    _plugin('core', function(K) {
        ...
        _each('link,image,flash,media,anchor,htmlfvideo'.split(','), function(i, name) {
